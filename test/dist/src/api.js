...
exports.APIError = exports.api = exports.Endpoint = void 0;
exports.Endpoint = process.env.API_ENDPOINT || 'http://localhost:3000/api';
async function api(key, payload) {
    ...
    return fetch(`${exports.Endpoint}${pathWithID || path}`, option).then(res => res.ok
        ? res.json()
        : res.text().then(text => {
